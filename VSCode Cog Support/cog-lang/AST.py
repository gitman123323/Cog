...
class LetStatement(Statement):
    def __init__(self, name: Expression = None, value: Expression = None, value_type: str = None, is_mutable: bool = False) -> None:
        self.name = name
        self.value = value
        self.value_type = value_type
        
        # Maybe ill keep it, maybe ill get rid of this is_mutable flag.
