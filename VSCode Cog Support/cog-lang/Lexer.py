...
class Lexer:
    def __init__(self, source: str) -> None:
        ...
        self.line_no: int = 1
        self.col_no: int = 0   # start at column 0
    ...
    def __new_token(self, tt: TokenType, literal: Any) -> Token:
        ...
        return Token(type=tt, literal=literal, line_no=self.line_no, col_no=self.col_no)
