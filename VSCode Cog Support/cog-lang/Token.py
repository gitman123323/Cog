...
class Token:
    def __init__(self, type: TokenType, literal: Any, line_no: int, col_no: int) -> None:
        self.type = type
    ...
    def __str__(self) -> str:
        return f"Token[{self.type} : {self.literal} : Line {self.line_no}, Col {self.col_no}]"
...
TYPE_KEYWORDS: list[str] = ["int", "float", "str", "void", "bool"]
